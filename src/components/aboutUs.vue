  ...
  <div class="progress">
    <div class="progress_inner">
      <div class="progress_inner__step">
        <label for="step-1">小组成员</label>
      </div>
      <div class="progress_inner__step">
        <label for="step-2">技术选型</label>
      </div>
      <div class="progress_inner__step">
        <label for="step-3">整体模块</label>
      </div>
      <div class="progress_inner__step">
        <label for="step-4">初衷</label>
      </div>
      <div class="progress_inner__step">
        <label for="step-5">设计理念</label>
      </div>
      ...
      <div class="progress_inner__tabs">
        ...
        <div class="tab tab-1">
          <h1>技术选型</h1>
          <br/>
          <p>技术上我们整体使用的是Vue，使用了antd的部分组件。其余都是使用原生js以及CSS3的一些特性去实现。</p>
        </div>
        <div class="tab tab-2">
          <h1>整体模块</h1>
          <br/>
          <p>整体的模块分为6个，分别是首页，基本介绍，战略城市，谋划历程，意义以及关于我们。</p>
        </div>
        <div class="tab tab-3">
          <h1>初衷</h1>
          <br/>
          <p>因为我们学校位于松山湖，而且松山湖恰巧在粤港澳大湾区之中是较为重要的一块战略高地。我们小组对其比较有兴趣，且大家都是知道这么个概念，对其战略意义不是十分了解。所以我们想要向大家介绍一下它。</p>
        </div>
        <div class="tab tab-4">
          <h1>设计理念</h1>
          <br/>
          <p>时间轴表示整个大湾区建设的历时之长，花费了很多人的心血和精力。而影响部分，我们设计了一个黑暗背景下的折叠画廊。寓意着我们粤港澳大湾区的成立，在原本黑暗的领域点亮了一座座灯塔。</p>
        </div>
      </div>
