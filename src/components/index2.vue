...
<body>
  <div class="player hide">
    <video id="video" width="960" height="720">
        <source src="../assets/videos/yga.mp4" type="video/ogg">
        <source src="../assets/videos/yga.mp4" type="video/mp4">
    </video>
  </div>
  <a class="btn-round close-btn hide" @click="toClose">关闭视频</a>
  <section class="main">
    <a class="btn-round video-btn" @click="toShow">观看视频</a>
    <router-link class="btn-round contact-btn" to="/main/introduction">了解更多</router-link>
...
.contact-btn:hover, .video-btn:hover, .close-btn:hover{
  background: #00B3FE;
  color: white;
}
